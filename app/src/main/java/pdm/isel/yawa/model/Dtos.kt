 ...
 */
data class CurrentWeatherInfoDto(val name: String, val coord: Coords, val weather: Array<Weather>, val main: Main, val wind: Wind, val dt: Long, val sys: Sys){}
...
data class City (val name: String, val country: String, val coord: Coords)
